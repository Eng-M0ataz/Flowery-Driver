...
import 'package:flowery_tracking/features/mainLayout/tabs/success_page/presentation/pages/order_thanks_page.dart';
  ...
  static Route<dynamic> getRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.orderSuccessRoute:
        return MaterialPageRoute(builder: (_) => const OrderThanksPageScreen());
      default:
