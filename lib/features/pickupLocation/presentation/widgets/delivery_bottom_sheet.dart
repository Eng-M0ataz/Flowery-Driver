...
//         List<int> orderedIndices = List.generate(deliveryLocations.length, (i) => i);
...
//                   itemCount: deliveryLocations.length + 1, // +1 for headers
...
//                         onPhoneCall: () => onPhoneCall(deliveryLocations[actualIndex].phoneNumber),
//                         onWhatsApp: () => onWhatsApp(deliveryLocations[actualIndex].phoneNumber),
//                       );
//                     } else if (index == 2) {
//                       // User address header
//                       return const Padding(
