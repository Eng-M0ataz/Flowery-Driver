...
String getSuccessMessage(ForgetPasswordState state) {
  if (state.forgetResponse?.info != null &&
      state.forgetResponse!.info.isNotEmpty) {
    return state.forgetResponse!.info;
  } else if (state.verifyResponse?.status != null &&
      state.verifyResponse!.status.isNotEmpty) {
    return state.verifyResponse!.status;
  } else if (state.resetResponse?.message != null &&
      state.resetResponse!.message.isNotEmpty) {
    return state.resetResponse!.message;
  }
