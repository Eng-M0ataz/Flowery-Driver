...
void provideDummyApiResults() {
  ...
  provideDummy<ApiResult<VehicleResponseEntity>>(
    ApiSuccessResult(data: VehicleResponseEntity()),
  );
}
...
void main() {
  ...
  setUp(() {
    ...
    profileViewModel = ProfileViewModel(
        mockGetVehicleUseCase, mockGetLoggedUserUseCase, mockEditProfileUseCase,
  ...
  group('ProfileViewModel Tests', () {
      ...
      test('should load driver data successfully', () async {
        ...
        final mockDriverProfileResponse = DriverProfileResponseEntity(
          driver: DriverEntity(
            ...
            phone: '+1234567890',
            photo: 'https://example.com/photo.jpg',
            vehicleType: 'vehicle_123', // ADD THIS - make sure it's not null
          ),
        );
        ...
        when(mockGetVehicleUseCase('vehicle_123')).thenAnswer(
              (_) async => ApiSuccessResult(data: VehicleResponseEntity()),
        );
        ...
        verify(mockGetVehicleUseCase('vehicle_123')).called(1); // Also verify this is called
      });
    ...
    group('LoadDriverDataEvent', () {
      ...
      test('should load driver data when LoadDriverDataEvent is called', () async {
        ...
        final mockDriverProfileResponse = DriverProfileResponseEntity(
          driver: DriverEntity(
            ...
            phone: '+1234567890',
            photo: 'https://example.com/photo.jpg',
            vehicleType: 'vehicle_1', // CRITICAL: This must not be null
          ),
        );
        ...
        final mockVehicleResponse = VehicleResponseEntity(
            message: 'Success',
            vehicle: VehicleEntity(
              Id: 'vehicle_1', // This should match the vehicleType above
              updatedAt: '5-1-2522',
              type: 'Moto',
              image: 'path',
              createdAt: '5-1-2522',
        ...
        when(mockGetVehicleUseCase('vehicle_1')).thenAnswer( // Use the same ID here
        ...
        verify(mockGetLoggedUserUseCase()).called(1);
        verify(mockGetVehicleUseCase('vehicle_1')).called(1); // Verify with the same ID
      });
      ...
      test('should handle driver data without vehicle type', () async {
        ...
        final driverWithoutVehicle = DriverProfileResponseEntity(
          driver: DriverEntity(
            ...
            phone: '+1234567890',
            photo: 'https://example.com/photo.jpg',
            vehicleType: null, // No vehicle type
          ),
        );

        when(mockGetLoggedUserUseCase()).thenAnswer(
              (_) async => ApiSuccessResult(data: driverWithoutVehicle),
        );
      ...
      test('should handle empty vehicle type string', () async {
        ...
        final driverWithEmptyVehicle = DriverProfileResponseEntity(
          driver: DriverEntity(
            ...
            phone: '+1234567890',
            photo: 'https://example.com/photo.jpg',
            vehicleType: '', // Empty vehicle type
          ),
        );
        ...
        verify(mockGetLoggedUserUseCase()).called(1);
        verify(mockGetVehicleUseCase('')).called(1); // Should call with empty string
      });
      ...
      test('should handle completely null driver data', () async {
        ...
        final nullDriverResponse = DriverProfileResponseEntity(driver: null);

        when(mockGetLoggedUserUseCase()).thenAnswer(
              (_) async => ApiSuccessResult(data: nullDriverResponse),
        );
